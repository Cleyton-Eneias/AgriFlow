...
Origem, destino, veículo e horário de saída.

### • Seleção de destino diretamente no mapa  
Incluindo identificação de **talhões** e **fundos agrícolas**.

### • Cálculo de rota otimizada  
Distância, duração e trajetória.

### • Gestão visual do status  
Agendado, ida, carregando, volta.

### • Exportação de dados  
Geração de arquivos **Excel (.xls)**.

### • Busca automática de fundos agrícolas  
Usando dados integrados do banco de dados e do GeoJSON.
